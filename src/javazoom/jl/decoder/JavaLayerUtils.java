...
class JavaLayerUtils
{
	 ...
	 */
	static private Object deserialize(InputStream in)
			throws IOException
			{
		if (in==null)
	...
	static private Object deserializeArray(InputStream in, Class elemType, int length)
			throws IOException
			{
		if (elemType==null)
	 ...
	 */
	@SuppressWarnings("rawtypes")
	static synchronized private InputStream getResourceAsStream(String name)
	{
		InputStream is = null;		
